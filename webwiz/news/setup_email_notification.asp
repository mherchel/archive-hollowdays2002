  ...
  <table width="97%" border="1" cellspacing="0" cellpadding="4" bordercolor="#000000">
   ...
   <td bgcolor="#EFEFEF"> 
    ...
    <p><b>Windows Win2k and XP Pro users</b> - CDOSYS comes installed on Win2k and XP Pro.<br>
     ...
     <br>
     If Web Wiz Site News crashes or you receive no e-mail's, you are either using the wrong component or your web host may not support sending mail from your web site.</p>
        </td>
    </tr>
  </table>
</div>
  ...
  <table width="680" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#000000">
    <tr> 
      <td width="680"> 
       ...
       Turn this function on if you wish to recieve e-mail notofication if one of your web site visitors eneters a comments for a news item</font></td>
