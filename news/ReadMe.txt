Web Wiz Guide - Web Wiz Journal realease v1.0
...
3. The default.asp page outside of the journal directory is only to show you the application running.

4. If you wish to add the Journal into your homepage or another page on the site place the journal
directory containing the main files as a sub directory of the page you wish to integrate the site
Journal items into.

5. Make sure your homepage or the page you want to place the Journal items displayed in has the 
extension .asp and place the following lines in the palce on the page where you wish the Journal
items to be displayed: -

For ASP 3 (Win2k Servers): -

	<% Server.Execute"journal_inc.asp" %>

For ASP 2 (NT4 Servers): -

	<!-- Start Journal Include File -->
	<!--#include file="journal_inc.asp" -->
	<!-- End Journal Include File -->

You can then delete the page default.asp that is outside of the journal directory as it will no longer 
be needed. 

5. To use the admin area to administer, set up, and add Journal items to Web Wiz Journal use the 
admin.htm file and login with the following case sesitive username and password: -

	Username - administrator
	Password - letmein

From the adminstartion files you can Add new Journal Items, Delete or amend Journal Items, Delete 
users comments, change colours, fonts, username, password, set up email notification, and more.


6. If you are having problems with running Web Wiz Journal then edit the files common.asp 
and journal_inc.asp with note pad where you can select to use a diffrent OBDC or OLE database 
driver or use DSN if you are able to setup DSN on your web server.

7. If you move the journal.mdb database to another directory then place the new path into the files 
common.asp and journal_inc.asp file.
...
the Journal.mdb database in this folder. 

2. Edit the file called common.asp with a text editor and uncomment the Brinkster 
...
Common database error when using the Web Wiz Journal
===========================================================================================
...
Problems running the Web Wiz Journal
===========================================================================================
