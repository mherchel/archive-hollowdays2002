...
If blnMailingListShow = True Then
	Response.Write("<tr><td align=""center"" height=""15"">")
	Response.Write("<span class=""text"" style=""font-size:10px"">Powered by<br><a href=""http://www.webwizguide.info"" target=""_blank"" style=""font-size:10px"">Web Wiz Mailing List</a></span>")
